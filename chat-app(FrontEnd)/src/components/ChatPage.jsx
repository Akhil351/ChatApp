...
const ChatPage = () => {
    ...
    return (
        <div className="">
            ...
            {/* content  */}
            <main ref={chatBoxRef} className="py-20 px-10  h-screen w-2/3 dark:bg-slate-600 mx-auto overflow-auto">
                {
                    messages.map((message, index) => (
                        <div key={index} className={`flex ${message.sender === currentUser ? "justify-end" : "justify-start"}`}>
                            <div className={`my-2 ${message.sender === currentUser ? "bg-green-800" : "bg-gray-800"} p-2 max-w-xs rounded `}>
                                <div className="flex flex-row gap-2">
                                    <img className="h-10 w-10" src={"https://avatar.iran.liara.run/public/47"} />
            ...
            <div className=" fixed bottom-4 w-full h-16">
                <div className="h-full pr-10  flex  gap-4 rounded-full items-center justify-between  w-1/2 mx-auto dark:bg-gray-900">
                    ...
                    type="text" placeholder="Type your message here..." className=" h-full w-full dark:border-gray-600  dark:bg-gray-800 px-5 py-2 rounded-full focus:outline-none" />
